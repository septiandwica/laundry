                ...
                <div class="card-body">
                    <div class="row p-4 ">
                        <div class="col-md-8 col-12">
                            <h2 class="mt-4 ml-5 text-primary">Selamat Datang <b> {{ auth()->user()->name }}!</b></h2>
                            <p class="ml-5 mt-4 text-dark" style="font-weight: 500;">
                            Selamat datang di FastClean Laundry! Senang melihat Anda di sini. Bersiaplah untuk pengalaman laundry yang cepat dan praktis. Login dan pantau barang laundry anda, serta nikmati kebersihan tanpa repot. Promo eksklusif menanti Anda!    
                        </p>
                        </div>
                        <div class="col-md-4 col-12 text-center ">
                            <img src="{{ asset('images/laundry.png') }}" class="laundry-gambar w-50 ">
                        </div>
                    </div>
                </div>
            </div>
