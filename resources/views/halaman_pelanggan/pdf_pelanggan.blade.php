...
<body>
	<div class="header">
		<table style="width: 100%;" class="table-header">
			<tr>
				<td style="padding-top: 50px; padding-left: 50px;"><img src="{{ asset('icons/logotoska.png') }}" class="logo-laundry"></td>
			...
			<tr>
				<td style="padding-left: 50px; line-height: 1.3; text-align: left; vertical-align: top;" rowspan="2">{{ $transaksis->kd_pelanggan . ', ' . $transaksis->nama_pelanggan }}<br>{{ $transaksis->email_pelanggan }}<br>{{ $transaksis->no_hp_pelanggan }}</td>
